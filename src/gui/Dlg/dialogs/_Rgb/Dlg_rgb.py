...
class Dlg_rgb(rgb_ui.Ui_Rgb, QtWidgets.QDialog):
    ...
    def __set_fr_color(self):
        ...
        Slider.rgb(self.sd_rgb_red, rgb_1=rgb_red_1, rgb_2=rgb_red_2)
        Slider.rgb(self.sd_rgb_green, rgb_1=rgb_green_1, rgb_2=rgb_green_2)
        Slider.rgb(self.sd_rgb_blue, rgb_1=rgb_blue_1, rgb_2=rgb_blue_2)
