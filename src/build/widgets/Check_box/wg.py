...
class wg:
    def __init__(
            self,
            *wgs,
            couleur_bg=p_base.COLORS.get("c1")+(255, ),
            couleur_bg_hover=p_base.COLORS.get("c1")+(255, ),
            couleur_bg_checked=p_base.COLORS.get("c3")+(255, ),
            couleur_bg_checked_hover=p_base.COLORS.get("c3")+(255, ),
