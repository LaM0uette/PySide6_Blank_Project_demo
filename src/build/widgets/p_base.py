...
COLORS_BG_HOVER= COULEURS.get("c1") + (255,)
COLORS_BG_CHECKED= COULEURS.get("c3") + (255,)
COLORS_BG_CHECKED_HOVER= COULEURS.get("c3") + (255,)
COLORS_BG_SELECTION=COULEURS.get("c3")
COLORS_BG_PRESSED=COLORS_BG_HOVER
COLORS_BG_CHECKED_PRESSED=COLORS_BG_CHECKED_HOVER
