...
COULEUR_BG_BARRE_HOVER= COULEURS.get("bn1") + (255,)
COULEUR_BG_BARRE_PRESSED= COULEURS.get("bn1") + (255,)
COULEUR_BG_CUR= COULEURS.get("c2") + (255,)
COULEUR_BG_CUR_HOVER= COULEURS.get("bn2") + (255,)
COULEUR_BG_CUR_PRESSED= COULEURS.get("bn1") + (255,)
