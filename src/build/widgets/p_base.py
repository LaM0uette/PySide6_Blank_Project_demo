...
COULEUR_BG_PLACEHOLDER= COULEURS.get("bn1") + (255,)
COULEUR_BG_BARRE= COULEURS.get("c3") + (255,)
COULEUR_BG_BARRE_HOVER= COULEURS.get("c3") + (255,)
COULEUR_BG_BARRE_PRESSED= COULEURS.get("c1") + (255,)
COULEUR_BG_CUR= COULEURS.get("c1") + (255,)
COULEUR_BG_CUR_HOVER= COULEURS.get("bn1") + (255,)
COULEUR_BG_CUR_PRESSED= COULEURS.get("bn2") + (255,)
...
COULEUR_BG_PRESSED=COULEUR_BG_HOVER
COULEUR_BG_CHECKED_PRESSED=COULEUR_BG_CHECKED_HOVER
COULEUR_BG_ITEM= COULEURS.get("c1") + (255,)
COULEUR_BG_ITEM_HOVER= COULEURS.get("c1") + (255,)
COULEUR_BG_ITEM_CHECKED= COULEURS.get("c3") + (255,)
COULEUR_BG_ITEM_CHECKED_HOVER= COULEURS.get("c3") + (255,)

# FG
COULEUR_FG=COULEURS.get("c3")
COULEUR_FG_PLACEHOLDER=COULEURS.get("bn2")
...
COULEUR_FG_CHECKED_PRESSED=COULEURS.get("bn2")
COULEUR_FG_ITEM=COULEURS.get("c3")
COULEUR_FG_ITEM_HOVER=COULEURS.get("bn1")
COULEUR_FG_ITEM_CHECKED= COULEURS.get("c2")
COULEUR_FG_ITEM_CHECKED_HOVER= COULEURS.get("bn1")
COULEUR_GRID=COULEURS.get("c3")
