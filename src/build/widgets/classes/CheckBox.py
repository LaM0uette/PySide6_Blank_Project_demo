...
class Style:
    def __init__(
            self,
            *wgs,
            colors_bg=p_base._COLORS_BG,
            colors_bg_hover=p_base._COLORS_BG_HOVER,
            colors_bg_checked=p_base._COLORS_BG_CHECKED,
            colors_bg_checked_hover=p_base._COLORS_BG_CHECKED_HOVER,
