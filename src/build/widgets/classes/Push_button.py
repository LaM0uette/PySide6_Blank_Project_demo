...
class Style:
    def __init__(self,
                 *wgs,
                 ...
                 couleur_bg_hover=p_base.COLORS_BG_HOVER,
                 couleur_bg_checked=p_base.COLORS_BG_CHECKED,
                 couleur_bg_checked_hover=p_base.COLORS_BG_CHECKED_HOVER,
                 ...
                 couleur_fg_hover=p_base.COLORS_FG_HOVER,
                 couleur_fg_checked=p_base.COLORS_FG_CHECKED,
                 couleur_fg_checked_hover=p_base.COLORS_FG_CHECKED_HOVER,
